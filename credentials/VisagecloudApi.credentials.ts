...
export class VisagecloudApi implements ICredentialType {
	name = 'N8nDevVisagecloudApi';

	displayName = 'visagecloud API';

	icon: Icon = { light: 'file:../nodes/Visagecloud/visagecloud.svg', dark: 'file:../nodes/Visagecloud/visagecloud.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your visagecloud API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
